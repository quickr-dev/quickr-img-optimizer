  ...
  return (
    <Container>
      ...
      <p>
        ...
        <a href="https://quickr.dev">https://quickr.dev</a> website and the Quickr.dev image optimization
        service (together, the "Service") operated by Quickr.dev ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        To use our Service, you need to create an account. When you create an account with us, you must
        provide us with accurate, complete, and up-to-date information. Failure to do so constitutes a breach
      ...
      <p>
        You retain full ownership of all images you optimize through our Service. We do not claim any
        ownership rights to your content.
      </p>

      <h2>3. Use of Data</h2>
      <p>
        To use our Service, your images must be publicly accessible. Our Service will download your images via
        Cloudflare workers to optimize them. By using our Service, you acknowledge and agree to this process.
      </p>

      <h2>4. Service Availability</h2>
      <p>
        Our Service operates on the Cloudflare infrastructure. While we strive to provide uninterrupted
        service, we do not guarantee 100% uptime. The Service may be subject to limitations, delays, and other
        issues inherent in the use of internet and electronic communications.
      </p>
      ...
      <p>
        In no event shall Quickr.dev, nor its directors, employees, partners, agents, suppliers, or
      ...
      <ul>
        ...
        <li>
          To optimize any content that is illegal, infringing, defamatory, obscene, invasive of privacy, or
          otherwise objectionable
        </li>
        <li>
          To engage in any other conduct that restricts or inhibits anyone's use or enjoyment of the Service,
          or which, as determined by us, may harm the Company or users of the Service or expose them to
          liability
        </li>
      </ul>
      ...
      <p>
        We reserve the right, at our sole discretion, to modify or replace these Terms at any time without
        notice. It is your responsibility to check the Terms periodically for changes. Your continued use of
        the Service following the posting of any changes to the Terms constitutes acceptance of those changes.
      </p>

      <h2>9. Governing Law</h2>
      <p>
        These Terms shall be governed and construed in accordance with the laws of Brazil, without regard to
      ...
      <p>
        ...
        <a href="mailto:support@quickr.dev">support@quickr.dev</a>.
      </p>
      <p>
        By using Quickr.dev, you acknowledge that you have read and understood these Terms of Service and
        agree to be bound by them.
      </p>

      <h1>Privacy Policy</h1>
      <p>
        At Quickr.dev, we are committed to protecting your privacy. This Privacy Policy explains our practices
        regarding the collection, use, and disclosure of your information through our image optimization
        service at <a href="https://quickr.dev">https://quickr.dev</a> (the "Service").
      </p>

      <h2>1. Information We Collect</h2>
      <p>
        The only personal information we collect is your email address, which is necessary for account
        creation and authentication purposes. This is managed through our authentication provider, Clerk.
      </p>

      <h2>2. How We Use Your Information</h2>
      <p>
        Your email address is used solely for the purpose of account creation and authentication. We do not
        use this information for any other purpose, such as marketing or analytics.
      </p>

      <h2>3. Data Storage and Security</h2>
      <p>
        Your email address is stored securely by our authentication provider, Clerk. We do not have direct
      ...
      <p>
        ...
        not include trusted third parties who assist us in operating our service, such as our authentication
        provider, as long as these parties agree to keep this information confidential.
      </p>

      <h2>5. Your Data Rights</h2>
      <p>
        You have the right to access, correct, or delete your personal information (in this case, your email
        address). If you wish to exercise these rights, please contact us using the information provided at
        the end of this policy.
      </p>

      <h2>6. Cookies and Tracking</h2>
      <p>Our service does not use cookies or any other form of tracking technology.</p>
      ...
      <h2>8. Image Data</h2>
      <p>
        While our service optimizes images, we do not store or retain any of the image data processed through
        our service. Images must be publicly accessible for our service to optimize them, but we do not
        collect or store this data.
      </p>

      <h2>9. Children's Privacy</h2>
      <p>
        Our Service does not address anyone under the age of 18. We do not knowingly collect personal
      ...
      <p>
        By using Quickr.dev, you acknowledge that you have read and understood this Privacy Policy and agree
        to its terms.
      </p>
    </Container>
  )
